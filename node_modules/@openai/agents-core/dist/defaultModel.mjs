...
export function getDefaultModel() {
    const env = loadEnv();
    return (env[OPENAI_DEFAULT_MODEL_ENV_VARIABLE_NAME]?.toLowerCase() ?? 'gpt-5.4-mini');
}
/**
