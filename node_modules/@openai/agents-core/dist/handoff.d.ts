...
export type HandoffCloneOptions<TContext = UnknownContext, TOutput extends AgentOutputType = TextOutput> = {
    /**
...
export declare class Handoff<TContext = UnknownContext, TOutput extends AgentOutputType = TextOutput> {
     ...
     */
    clone(overrides?: HandoffCloneOptions<TContext, TOutput>): Handoff<TContext, TOutput>;
    isEnabled: HandoffEnabledFunction<TContext>;
