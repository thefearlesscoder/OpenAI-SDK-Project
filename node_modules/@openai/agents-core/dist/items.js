...
exports.RunToolApprovalItem = exports.RunHandoffOutputItem = exports.RunHandoffCallItem = exports.RunReasoningItem = exports.RunToolCallOutputItem = exports.RunToolSearchOutputItem = exports.RunToolSearchCallItem = exports.RunToolCallItem = exports.RunMessageOutputItem = exports.RunItemBase = void 0;
...
class RunToolSearchCallItem extends RunItemBase {
    rawItem;
    agent;
...
exports.RunToolSearchCallItem = RunToolSearchCallItem;
class RunToolSearchOutputItem extends RunItemBase {
    rawItem;
    agent;
...
exports.RunToolSearchOutputItem = RunToolSearchOutputItem;
class RunToolCallOutputItem extends RunItemBase {
    ...
    constructor(rawItem, agent, output, customData) {
        super();
        this.rawItem = rawItem;
        this.agent = agent;
        this.output = output;
...
function getDefaultApprovalToolName(rawItem, agent) {
    if (rawItem.type !== 'function_call') {
        return rawItem.name;
    }
    const availableFunctionTools = new Map(agent.tools.flatMap((tool) => {
        if (tool.type !== 'function' || typeof tool.name !== 'string') {
            return [];
        }
        return [[(0, toolIdentity_1.getFunctionToolQualifiedName)(tool) ?? tool.name, tool]];
    }));
    const resolvedToolName = (0, toolIdentity_1.resolveFunctionToolCallName)(rawItem, availableFunctionTools);
