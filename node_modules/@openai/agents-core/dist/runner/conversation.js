...
class ServerConversationTracker {
     ...
     */
    prepareInput(originalInput, generatedItems, supplementalGeneratedItems = []) {
        const inputItems = [];
        ...
        const preparedGeneratedItems = (0, items_1.extractOutputItemsFromRunItems)(generatedItemsForInput, this.reasoningItemIdPolicy);
