...
async function runOutputGuardrails(state, runnerOutputGuardrails, output) {
    ...
    const guardrails = runnerGuardrails.concat(state._currentAgent.outputGuardrails.map(guardrail_1.defineOutputGuardrail));
    if (guardrails.length === 0) {
        return;
    }
