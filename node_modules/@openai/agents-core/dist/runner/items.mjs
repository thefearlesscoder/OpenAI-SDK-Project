...
export function stripReasoningItemIdForPolicy(item, reasoningItemIdPolicy) {
...
export function extractOutputItemsFromRunItems(items, reasoningItemIdPolicy) {
    return items
...
export function dropOrphanToolCalls(items, options) {
