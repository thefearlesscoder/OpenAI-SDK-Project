 ...
 */
function processModelResponse(modelResponse, agent, tools, handoffs, priorItems = [], toolNotFoundBehavior = 'raise_error') {
    const items = [];
    const runHandoffs = [];
    const runFunctions = [];
...
async function processModelResponseAsync(modelResponse, agent, tools, handoffs, state, priorItems = [], toolNotFoundBehavior = 'raise_error') {
    const clientToolSearchTool = (0, toolSearch_1.getClientToolSearchHelper)(tools);
