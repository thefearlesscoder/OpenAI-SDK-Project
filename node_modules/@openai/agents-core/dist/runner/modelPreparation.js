 ...
 */
async function prepareAgentArtifacts(state, executionAgent = state._currentAgent) {
    const capabilities = await collectAgentCapabilities(state, executionAgent);
    (0, toolSearch_1.validateClientToolSearchSupport)(capabilities.tools);
...
async function collectAgentCapabilities(state, executionAgent) {
    ...
    const configuredTools = (await executionAgent.getAllTools(state._context));
