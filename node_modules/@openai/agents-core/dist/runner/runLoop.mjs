...
export async function resumeInterruptedTurn(options) {
    ...
    const turnResult = await resolveInterruptedTurn(state._currentAgent, state._originalInput, state._generatedItems, state._lastTurnResponse, state._lastProcessedResponse, runner, state, toolErrorFormatter, agentToolParentRunConfig);
    applyTurnResult({
        state,
        turnResult,
