...
export class Capability {
    ...
    bindModel(_model, modelInstance) {
...
export function requireBoundSession(capabilityType, session) {
    if (!session) {
        throw new SandboxConfigurationError(`${capitalize(capabilityType)} capability is not bound to a SandboxSession`, { capability: capabilityType });
    }
    return session;
}
