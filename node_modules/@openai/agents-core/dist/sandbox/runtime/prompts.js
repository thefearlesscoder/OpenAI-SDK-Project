...
function renderFilesystemInstructions(manifest) {
    return prompt `
# Filesystem
...
function renderRemoteMountPolicyInstructions(manifest) {
    if (!manifestHasMountEntries(manifest)) {
        return undefined;
    }
    return renderRemoteMountInstructions(manifest);
}
function renderRemoteMountInstructions(manifest) {
    return prompt `
