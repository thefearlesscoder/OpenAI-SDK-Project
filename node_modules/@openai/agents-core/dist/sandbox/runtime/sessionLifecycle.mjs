...
export function registerSandboxPreStopHook(session, hook) {
...
export function hasSessionCleanup(session) {
...
export async function runSandboxSessionPreStopHooks(session) {
    await runManagedPreStopHooksForSession(session);
    await session.runPreStopHooks?.();
}
export async function runSandboxSessionPreStop(session, options) {
...
export async function cleanupSandboxSession(session, options) {
    const lifecycleOptions = cleanupLifecycleOptions(options);
    let cleanupError;
