...
exports.formatExecResponse = formatExecResponse;
exports.elapsedSeconds = elapsedSeconds;
const _shims_1 = require("@openai/agents-core/_shims");
const APPROX_BYTES_PER_TOKEN = 4;
function truncateOutput(output, maxOutputTokens) {
...
function formatExecResponse(args) {
    const lines = [
        `Chunk ID: ${(0, _shims_1.randomUUID)().replace(/-/g, '').slice(0, 6)}`,
