import { BaseMCPServerSSE, BaseMCPServerStdio, BaseMCPServerStreamableHttp, CallToolResult, CallToolResultContent, MCPListResourcesParams, MCPListResourcesResult, MCPListResourceTemplatesResult, MCPReadResourceResult, MCPServerSSEOptions, MCPServerStdioOptions, MCPServerStreamableHttpOptions, MCPTool } from '../../mcp';
export declare class MCPServerStdio extends BaseMCPServerStdio {
    ...
    callToolResult(_toolName: string, _args: Record<string, unknown> | null, _meta?: Record<string, unknown> | null): Promise<CallToolResult>;
