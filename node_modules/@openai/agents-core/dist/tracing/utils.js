...
exports.defaultTracingIdGenerator = exports.NOOP_TRACE_OR_SPAN_ID = void 0;
...
exports.NOOP_TRACE_OR_SPAN_ID = 'no-op';
/**
...
function generateTraceId() {
    return `trace_${(0, _shims_1.randomUUID)().replace(/-/g, '')}`;
}
/**
...
function generateSpanId() {
    return `span_${(0, _shims_1.randomUUID)().replace(/-/g, '').slice(0, 24)}`;
}
exports.defaultTracingIdGenerator = Object.freeze({
    generateTraceId,
    generateSpanId,
});
/**
...
function generateGroupId() {
    return `group_${(0, _shims_1.randomUUID)().replace(/-/g, '').slice(0, 24)}`;
}
/**
