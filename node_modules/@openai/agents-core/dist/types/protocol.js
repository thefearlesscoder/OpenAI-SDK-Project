...
exports.ToolReference = zod_1.z.object({
    type: zod_1.z.literal('tool_reference'),
 ...
 */
exports.ToolSearchOutputTool = zod_1.z.record(zod_1.z.string(), zod_1.z.any());
/**
 ...
 */
exports.ToolSearchCallArguments = zod_1.z.unknown();
exports.ToolSearchCallItem = exports.ItemBase.extend({
    type: zod_1.z.literal('tool_search_call'),
    call_id: zod_1.z.string().nullable().optional(),
    callId: zod_1.z.string().nullable().optional(),
    execution: zod_1.z.enum(['client', 'server']).optional(),
    arguments: exports.ToolSearchCallArguments,
    status: zod_1.z.string().optional(),
});
exports.ToolSearchOutputItem = exports.ItemBase.extend({
    type: zod_1.z.literal('tool_search_output'),
    call_id: zod_1.z.string().nullable().optional(),
    callId: zod_1.z.string().nullable().optional(),
    execution: zod_1.z.enum(['client', 'server']).optional(),
    status: zod_1.z.string().optional(),
    tools: zod_1.z.array(exports.ToolSearchOutputTool),
});
...
exports.ComputerUseCallItem = exports.ItemBase.extend({
     ...
     */
    action: exports.computerActions.optional(),
    /**
     * Batched actions returned by the GA computer tool.
     */
    actions: zod_1.z.array(exports.computerActions).min(1).optional(),
...
exports.ApplyPatchOperationUpdateFile = zod_1.z.object({
    ...
    path: zod_1.z.string(),
    diff: zod_1.z.string(),
    moveTo: zod_1.z.string().min(1).optional(),
});
...
exports.OutputModelItem = zod_1.z.discriminatedUnion('type', [
    exports.AssistantMessageItem,
    exports.ToolSearchCallItem,
    exports.ToolSearchOutputItem,
    exports.HostedToolCallItem,
    exports.FunctionCallItem,
    exports.ComputerUseCallItem,
    exports.ShellCallItem,
