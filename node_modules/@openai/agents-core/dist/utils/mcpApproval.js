...
exports.normalizeHostedMcpRequireApproval = normalizeHostedMcpRequireApproval;
...
function invalidRequireApproval(message) {
    return new errors_1.UserError(`Invalid hosted MCP requireApproval: ${message}`);
}
...
//# sourceMappingURL=mcpApproval.js.map