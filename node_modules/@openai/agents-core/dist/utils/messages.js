...
exports.getRefusalFromOutputMessage = getRefusalFromOutputMessage;
 ...
 * @returns
 */
function getRefusalFromOutputMessage(outputMessage) {
    const assistantMessage = getAssistantMessage(outputMessage);
    if (!assistantMessage) {
        return undefined;
    }
