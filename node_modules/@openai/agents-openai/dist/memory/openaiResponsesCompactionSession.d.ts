...
export declare class OpenAIResponsesCompactionSession implements OpenAIResponsesCompactionSessionLike, OpenAISessionApiTagged<'responses'> {
    ...
    private getAllUnderlyingSessionItems;
    private replaceUnderlyingSessionItems;
    private restoreUnderlyingSessionItemsAfterFailedClear;
    private restoreUnderlyingSessionItems;
