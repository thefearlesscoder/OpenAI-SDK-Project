...
class OpenAIChatCompletionsModel {
    ...
    async *getStreamedResponse(request) {
        ...
        try {
            ...
            for await (const event of (0, openaiChatCompletionsStreaming_1.convertChatCompletionsStreamToResponses)(response, stream, { strictFeatureValidation: this.#strictFeatureValidation })) {
