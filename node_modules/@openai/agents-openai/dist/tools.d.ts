import { HostedTool, type ClientToolSearchExecutor } from '@openai/agents-core';
import type OpenAI from 'openai';
import { z } from 'zod';
export declare const WebSearchStatus: z.ZodDefault<z.ZodEnum<{
    in_progress: "in_progress";
    completed: "completed";
    searching: "searching";
    failed: "failed";
}>>;
export declare const FileSearchStatus: z.ZodDefault<z.ZodEnum<{
    in_progress: "in_progress";
    completed: "completed";
    searching: "searching";
    failed: "failed";
...
export declare const CodeInterpreterStatus: z.ZodDefault<z.ZodEnum<{
    in_progress: "in_progress";
    completed: "completed";
    interpreting: "interpreting";
}>>;
export declare const ImageGenerationStatus: z.ZodDefault<z.ZodEnum<{
    in_progress: "in_progress";
    completed: "completed";
    failed: "failed";
 ...
 */
export declare function toolSearchTool<Context = unknown>(options?: Partial<Omit<ToolSearchTool<Context>, 'type'>>): HostedTool;
/**
