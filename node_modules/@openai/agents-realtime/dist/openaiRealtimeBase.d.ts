 ...
 */
export type OpenAIRealtimeModels = 'gpt-realtime' | 'gpt-realtime-1.5' | 'gpt-realtime-2' | 'gpt-realtime-2025-08-28' | 'gpt-4o-realtime-preview' | 'gpt-4o-realtime-preview-2024-10-01' | 'gpt-4o-realtime-preview-2024-12-17' | 'gpt-4o-realtime-preview-2025-06-03' | 'gpt-4o-mini-realtime-preview' | 'gpt-4o-mini-realtime-preview-2024-12-17' | 'gpt-realtime-mini' | 'gpt-realtime-mini-2025-10-06' | 'gpt-realtime-mini-2025-12-15' | (string & {});
/**
...
export declare abstract class OpenAIRealtimeBase extends EventEmitterDelegate<OpenAIRealtimeEventTypes> implements RealtimeTransportLayer {
    ...
    protected _getMergedSessionConfig(config: Partial<RealtimeSessionConfig>): RealtimeSessionPayload;
    /**
     ...
     */
    buildSessionPayload(config: Partial<RealtimeSessionConfig>): RealtimeSessionPayload;
     ...
     */
    protected _updateTracingConfig(tracingConfig: RealtimeTracingConfig | null): void;
    /**
    ...
    sendMcpResponse(approvalRequest: RealtimeMcpCallApprovalRequestItem, approved: boolean, reason?: string): void;
}
