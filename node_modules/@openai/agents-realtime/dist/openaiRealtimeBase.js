...
const utils_3 = require("@openai/agents-core/utils");
/**
 * The default model that is used during the connection if no model is provided.
 */
exports.DEFAULT_OPENAI_REALTIME_MODEL = 'gpt-realtime-2';
/**
...
class OpenAIRealtimeBase extends utils_3.EventEmitterDelegate {
    #model;
    #apiKey;
    #tracingConfig = null;
        ...
        const sessionData = {
            ...
            audio: {
                input: {
                    ...
                    noise_reduction: noiseReductionOverride === undefined
                        ? exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.audio?.input
                            ?.noiseReduction
                        : noiseReductionOverride,
                    transcription: transcriptionOverride === undefined
                        ? exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.audio?.input
                            ?.transcription
                        : transcriptionOverride,
                    turn_detection: turnDetectionOverride === undefined
                        ? exports.DEFAULT_OPENAI_REALTIME_SESSION_CONFIG.audio?.input
                            ?.turnDetection
            ...
            sessionData.tools = newConfig.tools.map((tool) => {
                ...
                if (tool.type === 'mcp') {
                    ...
                    return pickDefined({
                        ...
                        require_approval: typeof tool.require_approval === 'undefined'
                            ? undefined
                            : (0, utils_1.normalizeHostedMcpRequireApproval)(tool.require_approval),
                    });
                }
    ...
    sendAudio(audio, { commit = false } = {}) {
        this.sendEvent({
            ...
            audio: (0, utils_2.arrayBufferToBase64)(audio),
        });
        if (commit) {
            this.sendEvent({
    ...
    resetHistory(oldHistory, newHistory) {
        const { removals, additions, updates } = (0, utils_2.diffRealtimeHistory)(oldHistory, newHistory);
