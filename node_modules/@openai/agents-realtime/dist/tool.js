...
function toRealtimeToolDefinition(tool) {
    ...
    if (tool.type === 'hosted_tool' && tool.name === 'hosted_mcp') {
        ...
        const requireApproval = typeof tool.providerData.require_approval === 'undefined'
            ? undefined
            : (0, utils_1.normalizeHostedMcpRequireApproval)(tool.providerData.require_approval);
        return {
            type: 'mcp',
